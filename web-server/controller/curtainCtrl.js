...
/*const int = setInterval(() => {
    var sql = "SELECT value FROM device WHERE id = " + '010';
...
const device = iot.device({
    productKey: 'a1hQl23tdCe', //将<productKey>修改为实际产品的ProductKey
    deviceName: 'Curtain',//将<deviceName>修改为实际设备的DeviceName
    deviceSecret: '2b8ee38eba1a5923d3caca122538c6d2',//将<deviceSecret>修改为实际设备的DeviceSecret
})
device.on('connect', () => {
    //将<productKey> <deviceName>修改为实际值
    device.subscribe('/a1hQl23tdCe/Curtain/user/get');
    console.log('connect successfully!');
    //发送消息给谁
    device.publish('/a1hQl23tdCe/Curtain/user/update', 'hello world!');
});
