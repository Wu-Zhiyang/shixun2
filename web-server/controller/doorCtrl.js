...
/*const int = setInterval(() => {
    var sql = "SELECT value FROM device WHERE id = " + '009';
...
const device = iot.device({
    productKey: 'a1Sd6IgFLpM', //将<productKey>修改为实际产品的ProductKey
    deviceName: 'Door',//将<deviceName>修改为实际设备的DeviceName
    deviceSecret: '06f688488446dcb72f1bc6b6de757381',//将<deviceSecret>修改为实际设备的DeviceSecret
})
device.on('connect', () => {
    //将<productKey> <deviceName>修改为实际值
    device.subscribe('/a1Sd6IgFLpM/Door/user/get');
    console.log('connect successfully!');
    //发送消息给谁
    device.publish('/a1Sd6IgFLpM/Door/user/update', 'hello world!');
});
