...
const device = iot.device({
    productKey: 'a1jULKs3YT0', //将<productKey>修改为实际产品的ProductKey
    deviceName: 'Camera1',//将<deviceName>修改为实际设备的DeviceName
    deviceSecret: '3fe8f1ac24c5facf2933468fce6e82a7',//将<deviceSecret>修改为实际设备的DeviceSecret
})
device.on('connect', () => {
    //将<productKey> <deviceName>修改为实际值
    device.subscribe('/a1jULKs3YT0/Camera1/user/get');
    console.log('connect successfully!');
    //发送消息给谁
    device.publish('/a1jULKs3YT0/Camera1/user/update', 'hello world!');
});
