...
/*const int = setInterval(() => {
    var sql = "SELECT value FROM device WHERE id = " + '006';
...
const device = iot.device({
    productKey: 'a1Wdj8cuerY', //将<productKey>修改为实际产品的ProductKey
    deviceName: 'CSprinkler',//将<deviceName>修改为实际设备的DeviceName
    deviceSecret: '07e4d2b6deb0681583381e0848efb9bf',//将<deviceSecret>修改为实际设备的DeviceSecret
})
device.on('connect', () => {
    //将<productKey> <deviceName>修改为实际值
    device.subscribe('/a1Wdj8cuerY/CSprinkler/user/get');
    console.log('connect successfully!');
    //发送消息给谁
    device.publish('/a1Wdj8cuerY/CSprinkler/user/update', 'hello world!');
});
